    ...
    <body class="contenido" onload="ocultarFondoPrincipal();">
        ...
        <div id="fichaEditable" style="background-color:#ffffff;">
            <div class="cabeceraFicha"></div>
                <form id="entidad" name="entidad" method="post" action="actuacioInsertUpdate.php">
                    <div class="contenedorFicha">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label for="assumit_servei" class="campoFicha_Blanca"></label>
                                    <input type="checkbox" id="assumit_servei" name="assumit_servei" class="formularioFicha" <?php echo $assumitServei == "S" ? "checked" : "" ?>>
                                    <label class="campoFicha_Blanca" for="assumit_servei">Assumit pel servei</label>								
                                </td>
                            </tr>
                            <tr>
                                <td>
            ...
            <ul class="botoneraFicha">
                <li class="fondoBotoneraFicha">
                    <input type="submit" form="entidad" class="boton" onclick="return confirm('Estàs segur de desar els canvis?');" value="Desar canvis">
                </li>
                <li class="fondoBotoneraFicha">
                    <form method="post" action="actuacioDelete.php" style="display:inline;">
                        <input type="hidden" name="id" value="<?php echo $id ?>">
