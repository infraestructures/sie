...
--
-- Servidor: 127.0.0.1
-- Temps de generació: 08-08-2025 a les 10:52:25
...
-- Funcions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `generar_codi_actuacio` (`any_actual` INT) RETURNS VARCHAR(15) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci DETERMINISTIC BEGIN
  DECLARE seq INT;
...
CREATE DEFINER=`root`@`localhost` FUNCTION `generar_codi_conveni` (`any_actual` INT) RETURNS VARCHAR(15) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci DETERMINISTIC BEGIN
  DECLARE seq INT;
...
(115, '80-2025', '', 21, NULL, 'Sol·licitud d’instal·lació d’estructura de joc per al pati d’educació infantil', 0.00, 'N', '✅ Requisits pendents\r\n\r\nEl centre ha de completar els següents passos:\r\n\r\n    Demanar almenys 3 pressuposts comparables.\r\n    Incloure fotografies de l’espai i una imatge aèria amb la zona marcada.\r\n    Esperar el vistiplau d’Infraestructures.\r\n    Comunicar l’actuació a l’Ajuntament de Palma un cop aprovada.\r\n\r\n👉 El CEIP Tramuntana\r\nHa de completar i enviar la documentació (pressuposts, imatges i selecció d’elements) al Servei d’Infraestructures Educatives per obtenir el vistiplau.', 306, 3, 1, '2025-05-07', '0000-00-00', 1, 1, NULL, NULL, ''),
...
(263, '228-2025', '', 49, NULL, 'Informe d’Incidències per Humitats i Filtracions. Sol·licitud d’Actuacions Urgents', 0.00, 'N', 'Bon dia,\r\nVolíem comunicar les incidències que ens trobam al CEIP Joan Mas i Verd de\r\nMontuïri quan plou.\r\nJa es va comunicar després de la visita del Conseller al centre, els problemes\r\nd’humitats i inundació espais:\r\n“Actualment hi ha continus problemes d’humitats i inundació de diferents zones. Els\r\nterrats no drenen de forma correcta degut a l’excés d’excrements i brutícia de\r\ncoloms (es neteja dos pics a l’any com a mínim).\r\nA més, quan es varen suprimir les barreres a la primera planta l’aigua de pluja drena\r\ncap als despatxos de secretaria i direcció. L’agost 2023 es va inundar la sala de\r\nmestres (es va haver de reparar la fotocopiadora) i l’aigua va drenar fins al despatx\r\nde secretaria on es varen rompre dues plaques de guix i l’ordinador de secretaria. “\r\nAquest curs escolar 2024-25 s’han inundat diferents dependències:\r\n1. Al despatx D01, dia 13 de novembre 2024, hi va haver goteres i va caure\r\nbastanta aigua damunt el carret blanc on hi havia 36 CBK.\r\n2. Goteres D12 sempre que plou el despatx s’inunda creant també goteres al\r\nmagatzem d’educació física de la planta baixa (s’adjunten dos vídeos) i\r\nhumitats a les aules dels costats. A més a més, aquestes goteres fan botar\r\nels diferencials de diferents zones del centre, provocant caigudes de tensió\r\nque generen problemes als aparells elèctrics. Hem anat eliminant aparells\r\nCarrer d\'Emili Pou, s/n. 07230 Montuïri (Illes Balears)\r\nTelèfon: 971 16 15 60. E-mail: ceipjoanmasiverd@educaib.eu\r\n1\r\nCEIP Joan Mas i Verd\r\nMontuïri\r\nelèctrics de les zones on hi ha goteres de forma més freqüent ja que hem\r\nhagut de canviar ordinadors i fer diverses reparacions a aparells elèctrics\r\n(fotocopiadores, plastificadora…) a més de pèrdues d’exemplars en paper\r\n(llibres, col·leccions de lectures…).\r\n3. Goteres als despatxos de direcció i secretaria de la planta baixa degut a la\r\nfiltració d’aigua de la rampa del primer pis.\r\nAl llarg de l’estiu es pinten les aules del 2n i 1r pis i el pintor ha avisat que el sostre\r\nés de canyís i que ja hi ha diversos forats dels llums que pengen perquè el canyís\r\nestà podrit.\r\nDes del centre sol·licitam una revisió acurada dels sostres del centre, tenint en\r\ncompte l’estat en què es troben i afegint que cada vegada que plou es filtra aigua fet\r\nque empitjora la situació. És un perill urgent que s’ha d’abordar per part dels\r\nprofessionals adequats.', 328, 1, 3, '2025-07-15', '0000-00-00', NULL, NULL, NULL, NULL, ''),
...
(265, '1-2020', '', 201, NULL, '', 0.00, 'N', '', 14, 1, 1, '2020-07-16', '0000-00-00', NULL, 1, NULL, 1, ''),
(266, '230-2025', '', 219, NULL, 'Sol·licitud de reparació urgent de la reixa perimetral sud del centre.', 0.00, 'N', 'Requeriment R1/2025-2026. Reixa perimetral exterior de la zona sud. \r\n\r\nSol·licitam: la reparació URGENT del tancat i la reixa de la zona sud del centre.\r\n\r\n\r\nEls feim arribar aquest escrit per informar-los sobre l’estat de deteriorament de tota la zona sud del perímetre del centre, on hi ha una paret i una reixa en molt mal estat que generen una situació permanent de perill i manca de seguretat.\r\nAdjuntam, per a la vostra valoració, l’informe tècnic elaborat pel Servei de Prevenció del Personal Docent, així com un informe descriptiu de la zona afectada redactat pel mateix centre.\r\n\r\n\r\n R1c/2025-2026_SPRL47-2025TEC_IES Mari Angels Cardona_signed.pdf\r\n\r\n R1a_2025-2026. Reixa sud.pdf\r\nRestam a la vostra disposició per a qualsevol aclariment i us agrairíem que ens poguéssiu orientar sobre el procés de tramitació: codi de seguiment de l’expedient, gestions que ja s’han dut a terme i aquelles que el centre pot facilitar per agilitzar la intervenció.  \r\n\r\nCordialment,\r\n\r\n--\r\nNel Martí\r\nDirector', 805, 1, 1, '2025-07-16', '0000-00-00', NULL, 1, NULL, NULL, ''),
(267, '231-2025', '', 200, NULL, 'Sol·licitud autorització per instal·lació de 4 torres d\'il·luminació a la pista (pendent rebre doc sol·licitada)', 0.00, 'N', '14/07/2025: Rebuda per Distribució de l\'Aj. d\'Esporles la sol·licitud d\'autorització per instal·lació de 4 torres d\'il·luminació a la pista. Ens diuen que l\'ajuntament assumirà l\'execució i el cost.\r\n15/07/2025: Rebut @ d\'IBISEC de la mateixa autorització, que han rebut també per Distribució.\r\n25/07/2025: Enviada per NOTIB ofici de resposta a l\'Ajuntament. Informam que l\'ampliació del centre podria interferir a la instal·lació de la iluminació i per poder autoritzar els sol·licitem documentació.', 794, 1, 1, '2025-07-16', '0000-00-00', NULL, 2, NULL, NULL, ''),
(268, '232-2025', '', 223, NULL, 'Sol·licitud de suport tècnic per presència de Legionel·la a la xarxa d’aigua', 0.00, 'N', 'Antecedents:\r\n\r\n    El centre ha detectat presència de Legionella a la zona del pavelló poliesportiu, segons una auditoria recent.\r\n    S’han activat mesures preventives com la hipercloració i s’ha iniciat el procés de contractació del servei per elaborar el PPCL.\r\n    Es disposa de documentació tècnica, pressuposts i plànols de les instal·lacions.\r\n\r\nObservacions del centre:\r\n\r\n    Instal·lació d’aigua parcialment condemnada al pavelló, amb risc d’estancament.\r\n    Sistema d’aigua calenta alimentat per plaques solars fora d’ús.\r\n    Possibles deficiències estructurals que podrien afavorir la proliferació de Legionel·la.\r\n\r\nActuació:\r\n\r\n    Es crea l’expedient 232-2025 per donar seguiment a la incidència.\r\n    La documentació ha estat traslladada als tècnics del Servei d’Infraestructures per a valoració.\r\n    Es preveu programar una visita tècnica per a inspecció i diagnòstic de les instal·lacions.\r\n\r\nObjectiu:\r\n\r\n    Determinar si cal una intervenció estructural.\r\n    Donar suport al centre en l’elaboració i aplicació del PPCL.\r\n    Garantir la seguretat sanitària de les instal·lacions d’aigua.', 812, 1, 1, '2025-07-16', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(269, '233-2025', '', 72, NULL, 'Ens demanen la Retirada del rack', 0.00, 'N', 'Tenim un armari de Rac que no s’utilitza.\r\nEns hem traslladat al centre nou i ahí ens han col.locat totes les connexions noves a un nou armari.\r\nVaig iniciar aquesta sol.licitud amb la RT#83291 a través del Servei IBTIC, i ells ens han comunicat que aquest equipament és de la vostra competència.\r\n\r\nPodeu venir a cercar-lo?', 307, 1, 1, '2025-07-16', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(270, '234-2025', '', 229, NULL, 'Nou edifici CEIP Sa Casa Blanca 2', 0.00, 'N', '', 409, 1, 1, '2025-07-16', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(271, '235-2025', '', 228, NULL, 'Construcció Nou EI Son Serra, Sta. Margalida', 0.00, 'N', 'Per indicacions del secretari autonòmic, avui hem remès a l\'IBISEC, la sol·licitud de licitació de nova construcció de l\'EI Son Serra. S\'inclou el projecte d\'arquitectura, l\'actualització de preus, projecte d\'instal·lacions, la declaració d\'interès autonòmic i l\'informe d\'autorització. \r\n\r\nLa incidència ha estat enregistrada a l\'IBISEC amb número 2025-RE-1010', 863, 1, 1, '2025-07-16', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(272, '236-2025', '', 14, NULL, 'Adaptació del bany i altres actuacions al centre. Escalons, goteres i  impermeabilització del terrat.', 0.00, 'N', 'Bon dia Toni, som M. Aurora Mateu, directora del CEPA Francesc de Borja Moll. \r\nT\'he telefonat avui i estaves reunit. He deixat el meu contacte perquè em telefonis quan et vagi bé.\r\nVolia parlar amb tu d\'un seguit de temes que tenim pendents del nostre CEPA.\r\nURGENT!! Bany adaptat. Com deus saber cada curs es matriculen al centre persones amb mobilitat reduïda. Nosaltres reorganitzam les aules perquè aquestes persones puguin accedir a les classes de la planta baixa (només en tenim dues, una de gran i una de petita)  El curs 24-25 una alumna es va matricular, li varem adaptar l\'aula (lloc, taula...) a les seves necessitats però no podia anar al bany perquè els nostres banys no són adaptats i no permeten ni tan sols l\'accés a aquests amb cadira de rodes. Aquesta alumna va presentar una queixa i també es va donar de baixa. Ara acabam de saber que una altra persona amb mobilitat reduïda vol matricular-se a capacitació digital i ens tornarem a trobar amb la mateixa situació. Vàrem contactar amb Marco Alarcón per explicar-li aquesta necessitat i ens ha dit que ja està en les teves mans. Per això contactam directament amb tu per saber com està aquesta demanda.\r\nEscalons que s\'estan esbucant. L\'IBISEC té vàries demandes relacionades amb aquesta situació. Hi ha una escala d\'accés al pati i els escalon es van descloscant i ara ja es veuen els ferros de l\'estructura fins i tot surten cap a fora creant un perill de lesió per a l\'alumnat. T\'envio foto. Volem saber si aprofitant que vendran a fer el bany es podria arreglar també això.\r\nGoteres aula 9 i humitats aula A. Tenim pendents també aquestes dues situacions ja comunicades amb anterioritat.\r\nFinalment, ja hem realitzat la impermeabilització del terrat per poder les plaques solars. Vos comunicam que el centre ja ha fet el pagament . Per tant, quan volgueu podeu fer-nos l\'ingrés. Si necessites algun tipus de justificació, comunica\'ns ho a aquest correu ja que ho duu la secretària i ella et podrà fer arribar la documentació que necessitis.\r\nMoltes gràcies per tot. Estam en contacte. El meu telèfon és 609474804\r\nSalutacions cordials,\r\nM. Aurora Mateu Pol\r\nDirectora del CEPA Francesc de Borja Moll', 489, 1, 1, '2025-07-17', '0000-00-00', NULL, 1, NULL, NULL, ''),
(273, '237-2025', '', 224, NULL, 'Sol·liciten reformes al taller d\'automoció degut al estat de les instal·lacions', 0.00, 'N', 'A l\'atenció de:\r\nServei d\'Infraestructures Educatives\r\nSecretaria Autonòmica de Desenvolupament Educatiu\r\n\r\nAmb còpia:\r\nDirecció Territorial d\'Educació de Menorca\r\n\r\n\r\nRequeriment R2/2025-2026. Taller d\'automoció. \r\n\r\nSol·licitam: múltiples actuacions referides al sostre, l\'enrajolat, finestres, xarxa d\'evacuació, etc. del taller i l\'aula.\r\n\r\n\r\nD\'acord amb el correu electrònic de dia 8 de gener, en què se’ns requerien diferents informacions relatives a l’estat de les instal·lacions de l’IES Maria Àngels Cardona, i havent-hi donat resposta des del centre amb l’enviament de la documentació i la informació sol·licitades, us volem demanar si s’han obert expedients o iniciat actuacions per fer front a les deficiències exposades.  \r\n\r\nAdjuntam un document resum de l\'estat del taller d\'automoció.\r\n\r\n R2_2025-2026. Taller d\'automoció. pdf\r\n\r\n\r\nRestam a la vostra disposició per a qualsevol aclariment i us agrairíem que ens poguéssiu orientar sobre el procés de tramitació: codi de seguiment de l’expedient, gestions que ja s’han dut a terme i aquelles que el centre pot facilitar per agilitzar la intervenció.  \r\n\r\nCordialment,\r\n\r\n\r\n--\r\nNel Martí\r\nDirector', 805, 1, 1, '2025-07-17', '0000-00-00', NULL, 1, NULL, NULL, ''),
(274, '238-2025', '', 223, NULL, 'reparació murs bany gimnàs. Per donar resposta prioritària (Toni)', 0.00, 'N', 'Benvolgut Jaume\r\n\r\nEfectivament l\'estat d\'aquest nucli de banys requereix una intervenció de calat. A priori, i atenent a l’estat general del nucli de banys, considero adient dur a terme una reforma integral del mateix, que inclogui l’enderrocament dels envans divisoris d’obra i la seva substitució per panells fenòlics, amb l’objectiu de millorar les condicions d’higiene, funcionalitat i manteniment.\r\n\r\nEn relació amb el finançament de les obres, i independentment del mecanisme que finalment emprem (ja sigui amb fons propis o provinents de la Conselleria), és imprescindible disposar de pressuposts detallats. Per aquest motiu i amb la voluntat d\'avançar, us demanam que sol·liciteu al manco 3 pressupost per a l’adequació dels banys d\'acord amb les especificacions que trobareu al final de correu. Un cop tinguem la valoració econòmica podrem estudiar conjuntament el mecanisme de finançament.\r\n\r\nEspecificacions: (Formació de cabines de bany amb panells fenòlics amb estructura autoportant de sistema de tubs, pinces i frontisses d\'acer inoxidable. Panells de 13mm de gruix amb densitat >1,35g/cm3 tractament resistent a la humitat. Pom tirador de doble agafador i condemna lliure/ocupat amb obertura d’emergència. )\r\n\r\n PD: He traslladat el vostre missatge al personal del servei perquè en tenguin coneixement i puguin fer el seguiment corresponent de l’actuació.\r\n\r\nSalutacions cordials\r\n\r\nAntoni Morro Gomila\r\nCap del servei d\'Infraestructures Educatives\r\nDepartament de la Secretaria Autonòmica de Desenvolupament Educatiu\r\nConselleria d\'Educació i Universitats\r\nTel.:971 17 77 50- Ext 62175\r\n\r\nDe: jllompartpalou@educaib.eu <jllompartpalou@educaib.eu> en nombre de IES ALCÚDIA (PORT D\'ALCÚDIA) <iesalcudia@educaib.eu>\r\nEnviado: viernes, 11 de julio de 2025 11:51\r\nPara: Antoni Morro Gomila <amorrogomila@ibeducacio.eu>\r\nAsunto: reparació murs bany gimnàs IES ALCÚDIA\r\n \r\nBon dia.\r\nUs volem informar d\'unes d\'unes actuacions que creim necessàries.\r\nEs tracta d\'obres als murs de separació dels banys del gimnàs que presenten esquerdes i alhora perill de caiguda, per la qual cosa es fa necessaria la seva reparació.\r\nUs adjuntam una sèrie de fotogràfies.\r\nAtès que es tracta d\'elements estructurals del centre, voldriem saber si el pagament d\'aquestes obres aniran, en part o en la seva totalitat, a càrrec  de la Conselleria;  si el centre ha de fer un avançament d\'aquestes despeses i més envant la Conselleria se\'n farà càrrec. En el cas de que el nostre centre avanci els pagaments, quin seria el procediment a seguir per tal de que Conselleria ens fes el reintegrament de les despeses.\r\nQuedam a la vostra disposició per a qualsevol consulta o aclariment.\r\nMoltes gràcies.', 765, 1, 2, '2025-07-17', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(275, '239-2025', '', 219, NULL, 'Substitucio de les persianes d\'administració  del centre.', 0.00, 'N', 'A l\'atenció de:\r\nDepartament de Formació Professional i Qualificacions Professionals \r\n\r\nAmb còpia:\r\nDirecció Territorial d\'Educació de Menorca\r\n\r\n\r\nRequeriment R5/2025-2026.  Substitució de les persianes d\'administració.\r\n\r\nSol·licitam: L\'autorització per executar el pressupost de substitució de les persianes d\'administració remès dia 19 de març de 2025.\r\n\r\n\r\n\r\nEl 19 de març del 2025 es va enviar al Servei d\'Infraestructures Educatives un pressupost per a substituir les persianes de les aules d\'administració per unes altres de característiques similars. El pressupost puja a 755,90 €, que és el cost que té cada unitat, que, per un total de 25 unitats, fan un total de 18.897,50 €.\r\n\r\nS\'adjunta el pressupost i algunes imatges de les persianes a substituir.\r\n\r\nRestam a la vostra disposició per a qualsevol aclariment i us agrairíem que ens poguéssiu orientar sobre el procés de tramitació: codi de seguiment de l’expedient, gestions que ja s’han dut a terme i aquelles que el centre pot facilitar per agilitzar la intervenció.  \r\n\r\n\r\nCordialment,\r\n\r\n\r\nBon dia,\r\n\r\n\r\n\r\n--\r\nNel Martí\r\nDirector', 805, 1, 1, '2025-07-17', '0000-00-00', NULL, 1, NULL, NULL, ''),
(276, '240-2025', '', 224, NULL, 'Sol·licitud del centre per a arreglar diferents dificiencies.', 0.00, 'N', 'Bon dia,\r\n\r\nAdjuntam informe de deficiències que remetérem a l\'Ajuntament, amb la seva resposta.\r\n\r\nMoltes gràcies,\r\n\r\n    Maria J. Rivero Sampol\r\n              Directora\r\nCEIP Miquel Duran i Saurina\r\n       (Inca - Illes Balears)', 359, 1, 1, '2025-07-17', '0000-00-00', NULL, 1, NULL, NULL, ''),
(277, '241-2025', '', 224, NULL, 'Demolició estructura embigat pati', 0.00, 'N', 'En distintes ocasions us hem comunicat l’estat de l’embigat de l’estructura exterior situada al pati del nostre centre, per si s\'han de fer actuacions urgents i així evitar possibles problemes de despreniment o rompuda.\r\n\r\nPer altra banda, en el mateix lloc on es troba aquesta estructura està previst construir-hi una nova estructura tancada amb coberta per habilitar-ho com espai on poder realitzar distintes activitats. A la coberta es té previst instal·lar plaques solars, projecte que suposa  la implicació de distintes administracions (Conselleria d\'Empresa, Ocupació i Energia, Conselleria d\'Educació i Universitats i l’Ajuntament d’Alcúdia).\r\n\r\nPer tal de dur a terme aquestes actuacions es fa necessari l’enderrocament de l’estructura. Tenint en compte que aquesta estructura està composta d’elements amb embigat de fusta i columnes de formigó i ferro, caben dues possibilitats:\r\n\r\n1-    Demolició només de l’embigat de fusta i mantenir les columnes si es poden aprofitar per al projecte posterior de la nova instal·lació.\r\n\r\n2-    Demolició de tos els elements, tan embigat de fusta com columnes.\r\n\r\nPer aquesta raó disposam de distints pressuposts, alguns d’ells contemplen aquestes dues possibilitats de demolició:\r\n\r\n    -CONSTRUCIONES INMELIS\r\n\r\n   -CONSTRUCCIONES ANTONIO FERNÁNDEZ (PRESSUPOST demolicion vigas y pilares IES ALCUDIA + PRESSUPOST desmonte vigas de madera I.E.S. ALCUDIA)\r\n\r\n    -VORAMAR CONSTRUCCIÓ (PARTIDA 1)\r\n\r\nAtès que es tracta d\'elements estructurals, amb un cost de demolició molt elevat i inassumible per part del centre, voldriem saber si el pagament d\'aquestes obres aniran directament a càrrec de la Conselleria, o bé  si el centre ha de fer un avançament d\'aquestes despeses i més envant la Conselleria se\'n farà càrrec.\r\n\r\nS’adjunten fotografies.', 765, 1, 1, '2025-07-18', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(278, '242-2025', '', 224, NULL, 'Sol·liciten la reparació de diferents deficiències al centre. Goteres, paret exterior que es va inclinant al carrer. Quan plou el pati queda embassat.', 0.00, 'N', 'Bon dia:\r\n\r\nEns posam en contacte amb vosaltres per saber en quin estat es troba l\'informe del nostre centre després de la visita que ens vareu fer a finals de març degut a les intenses pluges que van ocasionar desperfectes i varen fer que s\'inundàs l\'edifici d\'infantil.\r\n\r\nA més a més,  aprofitàrem la visita per mostrar-vos altres deficiències com per exemple:\r\n\r\n- Les goteres de l\'edifici de primària.\r\n- La paret exterior del pati de primer que es va inclinant cap al carrer.\r\n- La problemàtica que tenim al pati que contínuament quan plou queda embassat i per tant no es pot fer servir.\r\n- Hi ha filtracions d\'aigua al gimnàs i, fins i tot, aquest curs escolar es va filtrar gasoil de la caldera al gimnàs.\r\n\r\nPer altra banda tenim espais exteriors amb molt de llocs disponibles però necessitaríem crear zones d\'ombra ja que no en tenim i creim que de cada vegada és molt més necessari.\r\n\r\nPer aquest motiu, ens agradaria saber si ens podeu informar de l\'estat actual del nostre informe i també de com ho podríem fer per agilitzar aquest procediment ja que pensam que a l\'estiu és un bon moment per arreglar-ho.\r\n\r\nDes del centre tenim intenció de mirar de reformar el pati per crear aquestes zones d\'ombra i a la vegada solucionar el problema d\'embassament d\'aigua al pati. Fins a quin punt vosaltres ens podríeu ajudar a iniciar aquest procés de reforma?\r\n\r\nGràcies\r\n\r\nSalutacions\r\nMargalida 636383756', 434, 7, 1, '2025-07-18', '0000-00-00', NULL, 1, NULL, NULL, ''),
(279, '243-2025', '', 1, NULL, 'Instal·lació Aire Condicionat', 0.00, 'N', 'Em pos en contacte amb vosaltres com a directora del CEIP Alexandre Rosselló, ubicat a Palma, per tal de sol·licitar formalment la vostra col·laboració en relació amb la instal·lació de sistemes d’aire condicionat al nostre centre. \r\n\r\nDavant les altes temperatures registrades durant els darrers cursos escolars,  consideram imprescindible dotar als espais del centre d’un sistema de climatització que garanteixi unes condicions òptimes per al desenvolupament de l’activitat educativa i laboral.\r\n\r\nCal remarcar que durant el mes de juliol i a finals d’agost (quan ens tornam a incorporar), la jornada de treball al despatx de direcció és insostenible per culpa de les altes temperatures que es registren, fet que dificulta el desenvolupament normal de les tasques administratives i de coordinació.\r\n\r\nEl nostre centre disposa de romanent econòmic suficient per assumir el cost de la instal·lació, però necessitam el vostre suport tècnic abans d’iniciar qualsevol actuació. Cal tenir en compte que l’edifici està catalogat com a edifici protegit, la qual cosa condiciona les possibles ubicacions de les unitats de climatització i fa imprescindible una valoració prèvia per part dels serveis tècnics.\r\n\r\nPer aquest motiu, sol·licitam que des d’IBISEC es pugui dur a terme un estudi tècnic o visita d’avaluació per determinar la viabilitat de la instal·lació, definir les ubicacions més adequades i establir les passes següents per a la seva execució d’acord amb la normativa vigent.\r\n\r\nQuedam a la vostra disposició per concretar una data per a la visita i facilitar tota la informació que considereu necessària.', 253, 1, 1, '2025-07-18', '0000-00-00', NULL, NULL, NULL, NULL, '');
INSERT INTO `actuacions` (`id`, `codi`, `codi_extern`, `subtipus_id`, `origen`, `descripcio`, `pressupost`, `assumit_servei`, `observacions`, `centre_id`, `estat_id`, `prioritat_id`, `data_entrada`, `data_enviament`, `tecnic_id`, `origen_id`, `desti_id`, `mode_enviament_id`, `url_ibisec`) VALUES
(280, '244-2025', '', 24, NULL, 'Millora de l\'espai de pati', 0.00, 'N', 'Contexto\r\n\r\nEl CEIP Sa Graduada ha iniciado el proyecto de dirección 2024-2028, cuyo objetivo principal es la mejora del espacio del patio para ampliar las posibilidades de juego y experimentación.\r\n🛠️ Acciones Realizadas\r\n\r\n    Creación de una comisión de patio con participación de profesorado y familias.\r\n    Recogida de propuestas de toda la comunidad educativa (familias, alumnado, docentes y personal no docente).\r\n    Elaboración de un proyecto de patio con acciones iniciales en el patio delantero, considerando seguridad y practicidad.\r\n    Coordinación con el ayuntamiento y brigada municipal para aspectos de mantenimiento.\r\n\r\n💰 Financiación\r\n\r\n    Concesión de dos subvenciones (2000 € y 2500 €).\r\n    Apoyo económico de la Asociación de Familias de Alumnos.\r\n    El centro cuenta con autonomía económica para ejecutar las acciones.\r\n\r\n⚠️ Limitaciones del Espacio\r\n\r\n    Dos patios con espacio reducido y pocas posibilidades de juego.\r\n    Escasez de zonas de sombra y espacios naturales.\r\n\r\n📝 Solicitud\r\n\r\nSe solicita al Servei d’Infraestructures Educatives:\r\n\r\n    El visto bueno técnico y de seguridad para ejecutar las acciones del proyecto.\r\n    Se destaca la urgencia debido a los plazos de justificación de las subvenciones (por ejemplo, el CIME exige justificación antes del 30 de noviembre).', 412, 1, 1, '2025-07-18', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(281, '245-2025', '', 219, NULL, 'Substitucio de persianes de llenya a la zona d\'hoteleria i a la primera planta.', 0.00, 'N', 'A l\'atenció de:\r\n\r\nServei d\'Infraestructures Educatives\r\nSecretaria Autonòmica de Desenvolupament Educatiu\r\n\r\nAmb còpia:\r\nDirecció Territorial d\'Educació de Menorca\r\n\r\n\r\nRequeriment  R6/2025-2029. Persianes de llenya\r\n\r\nSol·licitam: la substitució de les persianes de llenya de la zona d\'hoteleria i de la primera planta de l\'edifici central.\r\n\r\n\r\nEls feim arribar aquest escrit (adjunt) per informar-los de l’estat de deteriorament de les persianes de llenya de la zona d’hoteleria i de la primera planta de l’edifici central.\r\nTot i que fins ara s’hi havien fet reparacions puntuals, actualment el seu estat no permet cap actuació de manteniment addicional, i s’ha hagut d’optar per la seva retirada a causa del perill que representaven.\r\n\r\nRestam a la vostra disposició per a qualsevol aclariment i us agrairíem si ens poguéssiu orientar sobre el procés de tramitació: el codi de seguiment de l’expedient, les gestions que ja s’han dut a terme i aquelles en què el centre pugui col·laborar per agilitzar la intervenció.\r\n\r\n\r\nCordialment,\r\n\r\n\r\n--\r\n\r\nNel Martí\r\nDirector', 805, 1, 1, '2025-07-18', '0000-00-00', NULL, 1, NULL, NULL, ''),
(282, '246-2025', '', 219, NULL, 'Tancat lateral del passadís exterior d’entrada.', 0.00, 'N', 'A l\'atenció de:\r\n\r\nServei d\'Infraestructures Educatives\r\nSecretaria Autonòmica de Desenvolupament Educatiu\r\n\r\nAmb còpia:\r\nDirecció Territorial d\'Educació de Menorca\r\n\r\n\r\nRequeriment  R8/2025-2029. Tancat lateral del passadís exterior d’entrada.\r\n\r\nSol·licitam: La reparació o substitució del tancat lateral del passadís exterior d’entrada.\r\n\r\n\r\n\r\nEls feim arribar aquest escrit per informar-los de l’estat de deteriorament i de la caiguda de la tanca lateral del passadís exterior de l’entrada del centre. Segons les consultes que hem pogut fer, la reparació requeriria una actuació que consistís a construir una base de ciment que permeti fixar-hi la tanca de manera segura, ja que actualment es troba subjectada directament a terra (vegeu imatges), fet que la fa inestable i que es deteriori ràpidament.\r\n\r\nRestam a la vostra disposició per a qualsevol aclariment i us agrairíem si ens poguéssiu orientar sobre el procés de tramitació: el codi de seguiment de l’expedient, les gestions que ja s’han dut a terme i aquelles en què el centre pugui col·laborar per agilitzar la intervenció.', 805, 1, 1, '2025-07-18', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(283, '247-2025', '', 224, NULL, 'Estat perillós de les lamel·les de les finestres del centre', 0.00, 'N', 'Ens adreçam una vegada més a vosaltres des del CEIP Santa Isabel per expressar la nostra preocupació respecte a l\'estat de les lames de les finestres del nostre centre educatiu.\r\n\r\nEn diverses ocasions ja hem comunicat que aquestes lames no es troben en bon estat. Malauradament, ja se n’han desprès vàries en diferents moments, amb el consegüent risc per a l’alumnat i el personal del centre. De fet, actualment hi ha aules on falten lames i les finestres queden parcialment obertes, amb el perill que suposa que algun infant pugui arribar a caure.\r\n\r\nConsideram que la vida útil d’aquest sistema de tancament ja ha caducat i que no ofereix ni garanties de seguretat ni de funcionalitat. Per això, demanam amb urgència que es valori la substitució de les actuals lames per un sistema alternatiu més segur i eficient, abans que hàgim de lamentar cap incident greu.\r\n\r\nAgrairem una resposta tan aviat com es pugui i quedam a la vostra disposició per a qualsevol aclariment.', 433, 1, 1, '2025-07-18', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(284, '248-2025', '', 57, NULL, 'Pèrgola edifici d\'Infantil', 0.00, 'N', 'Adjuntem imatge (requadre vermell entrada primer cicle d\'educació infantil) de l\'edifici d\'infantil a on volem instal·lar una pèrgola de 3x2m. per resguardar els cotxets de l\'alumnat de 2n i 3r d\'educació infantil.\r\nProcediment: \r\n- 1 pilar de fusta de 20cm de diàmetre encimentat a la part inferior. \r\n- Els altres 3 punts estructurals estaran ancorats a la paret amb sistema de soquets metàl·lics d\'expansió de 10cm.\r\n- El cobriment serà amb plaques de policarbonat transparent amb el sistema d\'ancoratge corresponent.\r\n\r\nRecordar-vos també que tenim pendent el tema de l\'escala d\'emergències de l\'edifici C.\r\n\r\nEsperam la vostra resposta per poder iniciar-ho el més aviat possible abans de començar el curs 25-26.', 329, 1, 1, '2025-07-18', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(285, '249-2025', '', 57, NULL, 'Sol·licitud d\'informe per a pèrgola', 0.00, 'N', 'L\'AMPA i l\'alumnat fa temps que reclamen una cobertura per al \"pàrquing\" de bicis i patinets que tenim, ja que quan plou es banyen. L\'AMPA va aconseguir un pressupost que us adjunt. Però a la recent formació vau dir que també necessiten un informe tècnic. El fa infraestructures? O l\'ha de trobar l\'AMPA?\r\n\r\nEl pressupost com a tal necessita un altre format? N\'hi ha dues pèrgoles al pressupost, la segona és la que volen fer (2800 €). La despesa és a càrrec de l\'AMPA. L\'Ajuntament va dir que els semblava bé, perquè ells no anaven a fer cap millora de la situació, però els demanarem per escrit com amb les altres instal·lacions noves.', 344, 1, 1, '2025-07-18', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(286, '250-2025', '', 224, NULL, 'Subtitucio de la porta al taller de mecànica.', 0.00, 'N', 'A l\'atenció de:\r\n\r\nServei d\'Infraestructures Educatives\r\nSecretaria Autonòmica de Desenvolupament Educatiu\r\n\r\nAmb còpia:\r\nDirecció Territorial d\'Educació de Menorca\r\n\r\n\r\nRequeriment  R10/2025-2029. Canvi de porta al taller de mecànica.\r\n\r\nSol·licitam: El canvi de porta per accedir al pla aspirant del taller de mecànica.\r\n\r\n\r\nEls volem informar de la necessitat de substituir la porta actual del taller de mecànica, que es troba en molt mal estat, apedaçada i amb filtracions. Proposam la instal·lació d’una porta corredissa que permeti l’entrada directa de vehicles des de l’exterior. Aquesta actuació és imprescindible, ja que fins ara els cotxes havien d\'accedir travessant tot el taller per arribar al pla aspirant, amb les molèsties i riscos que això suposa, i obligant a buidar el taller d\'altres vehicles.\r\n\r\nRestam a la vostra disposició per a qualsevol aclariment i agrairíem que ens poguéssiu informar sobre els passos a seguir per tramitar aquesta sol·licitud.\r\n\r\n\r\n\r\n--\r\nNel Martí\r\nDirector', 805, 1, 1, '2025-07-18', '0000-00-00', NULL, 1, NULL, NULL, ''),
(287, '251-2025', '', 3, NULL, 'Instal·lació ventiladors de sostre', 0.00, 'N', 'Ens posam en contacte amb voltros, perquè el nostre claustre sol.licita la instal.lació de ventiladors en el sostre, de totes les aules de la nostra escola. \r\n\r\nÉs una escola que té quasi 50 anys i no tenim cap dependència on hi hagi aire acondicionat. Les mestres duen ventiladors portàtils de casa per paliar la calor que fa, principalment, durant els mesos de juny i setembre, perquè els infants estiguin més \"frescos\". L\'equip directiu també hi romana durant el juliol. \r\n\r\nDins l\'edifici principal, disposam de 18 aules d\'Infantil i Primària, 2 de UEECO, 2 d\'anglès, una biblioteca i un laboratori. A l\'edifici Annex, hi ha l\'aula de Religió i l\'aula de Música. \r\nA la planta baixa hi ha les aules d\'Infantil, les de UEECO i la biblioteca. La resta estan ubicades al primer pis.\r\n\r\nLes aules tenen entre 55 m2 i 68 m2. L\'alçada és de 3m. Són de forma rectangular.\r\n\r\nAdjuntam les fotos de dues aules d\'Infantil i Primària i les dues de UEECO. \r\n\r\nEsperam tingueu en compte la nostra petició i poder tenir notícies pel setembre per donar una alegria al claustre i al nostre alumnat i famílies.', 338, 1, 1, '2025-07-18', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(288, '252-2025', '', 1, NULL, 'Sol·liciten la instal·lacio d\'aires condicionats als edificil d\'infantil i primaria', 0.00, 'N', 'Bon dia, degut a les altes temperatures que sofrim al nostre centre, vos enviam sol.licitud de climatització dels dos edificis, tant d\'infantil com de primària en la major brevetat possible.\r\n\r\nAgraint la vostra atenció i esperant la consideració de la nostra petició.\r\n\r\nSalutacions cordials,\r\n\r\n\r\n--', 330, 1, 1, '2025-07-18', '0000-00-00', NULL, 1, NULL, NULL, ''),
(290, '254-2025', '', 5, NULL, 'Ampliació de la finestra de consergeria per atendre a totes les persones que acudeixen al centre.', 0.00, 'N', 'Bon dia,\r\n\r\nTal i com es recull a les instruccions per al manteniment i infraestructures dels centres us comuniquen la nostra intenció de realitzar una intervenció a l\'espai de la Consergeria del centre IES Moll Vell. Per això sol·licitem la vostra autorització.\r\n\r\nEs tractaria d\'ampliar la finestreta d\'atenció al públic pel fet que l\'espai habilitat actualment és insuficient per atendre totes les persones que acudeixen a la consergeria. Aquest obra seria senzilla i requereix la modificació d\'una porta i el canvi del vidre i del taulell.\r\nAdjuntem el document de sol·licitud i esperem les vostres indicacions.\r\n\r\nGràcies i salutacions,\r\n\r\n\r\n--\r\nCristina Moyà Company\r\nDirectora IES Moll Vell\r\nC/Bisbe Pont nº9\r\n07400 Port d\'Alcúdia\r\nTfn: 971547246', 812, 1, 1, '2025-07-21', '0000-00-00', NULL, 1, NULL, NULL, ''),
(291, '255-2025', '', 1, NULL, 'Instal·lació Aire Condicionat', 0.00, 'N', '', 449, 1, 1, '2025-07-21', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(292, '256-2025', '', 219, NULL, 'Substitució de lamel·les i carpinteria exterior. L\'ajuntament de SJLabritja Resten a l\'espera de com procedir', 0.00, 'N', 'Buenos días Helena, gracias por la información facilitada, aunque no era esa la solicitud, me refiero a que se están realizando diversas actividades dentro de un mismo ámbito (CEIP Sant Joan de Labritja) y a mi entender deberían ser coordinadas por el \"promotor\" de las mismas que en este caso entiendo es IBISEC, quedo a la espera de que me indiquen cómo proceder, gracias. ', 333, 1, 1, '2025-07-22', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(293, '257-2025', '', 228, NULL, 'Nou CEIP Felanitx', 0.00, 'N', '', 864, 1, 1, '2025-07-22', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(294, '258-2025', '', 19, NULL, 'Necessitat urgent de reparació del sistema de extracció de fums. Ho sol·licita l\'Ajuntament de Manacor', 0.00, 'N', 'Ens posam en contacte amb vosaltres per informar-vos de la necessitat urgent de reparar el sistema d\'extracció de fums de la cuina del CEIP Jaume Vidal i Alcover de Manacor. \r\nCom podeu veure a les fotografies que us adjuntam, els tubs presenten uns forats que dificulten el funcionament correcte del sistema i, a més, permeten l\'entrada d\'aigua quan plou. L\'entrada d\'aigua ja ha provocat problemes d\'humitats i ha afectat el cel-ras d\'algunes aules que s\'haurà de canviar.  \r\nTambé des de la direcció del centre ens han fet saber que els problemes d\'extracció fan que tot l\'edifici faci olor ja des de primera hora del matí la qual cosa resulta molt desagradable per a tothom. \r\nPer això us demanam que vulgueu revisar tota la instal.lació i reparar el que faci falta.\r\n\r\nPer altra banda, la direcció demana que per contribuir a aïllar les olors de la cuina es faci un tancament de vidre a la \"finestra\" que  hi ha entre la cuina i el menjador. Aquesta finestra pareix que estava dissenyada com a \"pasa-plats\" i te unes mides de 2,28 x 0,88 cm. És necessari  prendre aquesta mesura perquè el centre ha d\'utilitzar una part del menjador durant les hores lectives. Us podreu encarregar de valorar-ho i fer la intervenció que considereu més adient?\r\n\r\nAtentament,\r\nAjuntament de Manacor\r\nDepartament d\'Educació\r\nTelèfon 662349729', 324, 1, 1, '2025-07-22', '0000-00-00', NULL, NULL, NULL, NULL, ''),
(295, '259-2025', '', 224, NULL, 'Perill despreniment mur colindant amb EMAYA', 0.00, 'N', 'Se adjuntan en dos correos consecutivos el plano del patio y  las imágenes del estado del muro que colinda con EMAYA, preocupa especialmente el muro del patio de infantil ( fotos 1,2 y 3) ya que puede desprenderse.\r\n\r\nSe ruega valoración y actuación prevista antes del inicio del periodo lectivo. \r\nEn espera de su respuesta. Gracias', 467, 1, 1, '2025-07-22', '0000-00-00', NULL, 1, NULL, NULL, ''),
(296, '260-2025', '', 1, NULL, 'Instal·lacio d\'aire condicionat.', 0.00, 'N', 'Bon dia,\r\n\r\nD\'acord amb la conversa telefònica mantinguda amb el tècnic Miquel Torrens i amb el correu electrònic rebut, sol·licitam poder dur a terme la despesa proposada de climatització fent l\'aportació d\'aire posteriorment i  no en aquest moment, per falta de temps i pressupost per gestionar-ho.\r\nTambé demanam rebre una partida econòmica per poder dur a terme l\'acció. El pressupost és de 6570€ més IVA. Estam fent un esforç important des del centre per poder climatitzar els espais i és difícil acometre les diferents accions només amb el pressupost del centre. \r\n\r\nSalutacions \r\n\r\n--\r\nAntoni Garau Ramon\r\nDirector\r\nCIFP Pau Casesnoves\r\nCarrer Joan Miró, 2\r\n07300 Inca\r\nTel. 971 07 32 62', 523, 11, 1, '2025-07-22', '0000-00-00', 1, 1, NULL, NULL, ''),
(297, '261-2025', '', 65, NULL, 'Instal·lació de panells acustics per tal d\'aillar l\'aula de musica.', 0.00, 'N', 'Bon dia Montse,\r\n\r\nEn primer lloc, demanar-te si em pots escriure els correus a la meva adreça d\'ibeducacio (hguinjoan@ibeducacio.eu), perquè no se\'m redirigeixen des del meu correu del domini @sade.caib.es (sí que se\'m reenvien altres correus).\r\n\r\nHe revisat els pressupostos que ens heu enviat des del CEIP Mestre Lluís Andreu i us faig arribar les següents consideracions:\r\nSón pressupostos per comprar material de construcció (panells acústics i adhesius), però no inclouen la instal·lació dels panells, de manera que en cas de defectes d\'execució no es podrà reclamar a l\'empresa instal·ladora.\r\nLes captures de pantalla de les cistelles de compra de les empreses Soniflex i Acústica decorativa no es poden considerar pressupostos.\r\n\r\nPer tant, per poder autoritzar l\'actuació és necessari presentar pressupostos per als següents conceptes:\r\nEls pressupostos han de ser d\'empreses especialitzades en acústica.\r\nHan de contemplar tant el subministrament com la instal·lació dels panells acústics.\r\nEn el pressupost és necessari identificar cadascun dels espais que es volen condicionar acústicament, amb una descripció de les característiques i del nombre de panells que es volen col·locar a cada espai en base a un estudi acústic previ.\r\nDe forma general, han d\'incloure la gestió de residus i els mitjans auxiliars per executar els treballs. A mode de recordatori, els pressupostos han d\'incloure el desglossament de l\'IVA i l\'import final (IVA inclòs).\r\n\r\nEn les actuacions de millora acústica es poden admetre lleugeres variacions en els pressupostos, atès que cada empresa sol tenir proveïdors diferents, cosa que té repercussió en les dimensions dels panells, per exemple. El concepte general i l\'àrea d\'actuació han de ser els mateixos, és a dir, si es col·loquen panells acústics, els tres pressupostos han de valorar si estan adherits al sostre i parets o bé són panells penjats, perpendiculars al sostre.\r\n\r\nPos en còpia el meu company, Miquel Torrens.\r\n\r\nEstic a la teva disposició per a qualsevol aclariment addicional.\r\n\r\nSalutacions cordials,\r\n\r\nHelena Guinjoan Palau-Ribes\r\nServei d\'Infraestructures Educatives\r\nSecretaria Autonòmica de Desenvolupament Educatiu\r\nConselleria d\'Educació i Universitats\r\nTel. 971 17 78 00 - Ext 63692', 352, 1, 1, '2025-07-23', '0000-00-00', NULL, 1, NULL, NULL, ''),
(300, '264-2025', '', 224, NULL, 'La reparació o la renovació de l’asfalt del pàrquing del centre.  La senyalització i ordenació de les places d’aparcament.  L’habilitació de l’entrada al centre a través del pàrquing.', 0.00, 'N', 'A l\'atenció de:\r\nServei d\'Infraestructures Educatives\r\nSecretaria Autonòmica de Desenvolupament Educatiu\r\n\r\nAmb còpia:\r\nDirecció Territorial d\'Educació de Menorca\r\n\r\n\r\nRequeriment R12/2025-2026. Pàrquing. Reparar o asfaltar de nou.\r\n\r\nSol·licitam:\r\n\r\nLa reparació o la renovació de l’asfalt del pàrquing del centre.\r\n\r\nLa senyalització i ordenació de les places d’aparcament.\r\n\r\nL’habilitació de l’entrada al centre a través del pàrquing.\r\n\r\n\r\n\r\n1. Reparació i adequació del pàrquing (1200 metres quadrats aproximadament)\r\nDurant el mes de juliol s’han adjudicat les obres de construcció del nou poliesportiu del centre, que, previsiblement, s’hauran d’enllestir l’octubre de 2026. Consideram que aquest serà un bon moment per dur a terme la millora del pàrquing adjacent al nou equipament, ja requerit en altres ocasions. Aquesta actuació hauria d’incloure la renovació de l’asfalt, així com l’ordenació i la senyalització de les places d’estacionament. \r\n\r\n\r\n2. Recuperació de l’accés al centre des del pàrquing\r\nPer motius que desconeixem, la porta d’accés al centre des del pàrquing va quedar inutilitzada arran de la instal·lació d’una pèrgola fotovoltaica. Demanam que s’actuï sobre la reixa per tal de recuperar aquest accés, que consideram necessari per a la mobilitat i la funcionalitat de l’espai.\r\n\r\n\r\n\r\nAdjunt fotografies de la porta inhabilitada i de l\'estat de l\'aparcament.', 805, 1, 1, '2025-07-23', '0000-00-00', NULL, 1, NULL, NULL, ''),
(302, '266-2025', '', 202, NULL, 'Reparació deficiencies OCA', 0.00, 'N', 'Bon dia, fa unes setmanes ens ferem una OCA de baixa tensió. Per subsanar les diferents deficiències trobades hem demanat tres pressuposts seguint instruccions. Adjunt aquests pressupostos i  necessitam que les valoreu i ens informeu el més aviat possible, per tal de poder subsanar les deficiències.\r\n\r\nEsperam la vostra resposta.\r\n\r\n--\r\nAntònia Ramis Perelló\r\n- Secretària -  IES BERENGUER D\'ANOIA', 772, 11, 1, '2025-07-23', '0000-00-00', 1, 1, NULL, NULL, ''),
(305, '269-2025', '', 224, NULL, 'Substitucio del parallamps.', 0.00, 'N', 'A l\'atenció de:\r\nServei d\'Infraestructures Educatives\r\nSecretaria Autonòmica de Desenvolupament Educatiu\r\n\r\nAmb còpia:\r\nDirecció Territorial d\'Educació de Menorca\r\n\r\n\r\nRequeriment R13/2025-2026. Parallamps\r\n\r\nSol·licitam: La instal·lació del parallamps\r\n\r\n\r\n\r\nAntecedents: arran d\'una tormenta l\'any 2022 el poliesportiu i el parallamps del centre van quedar destruits. Es va demanar pressupost per reparar el parallamps, però les empreses en demanaven un informe del servei de verificació de l\'actual sistema de protecció externa. Aquest informe i pressupost s\'adjunta.\r\n\r\nA partir d\'aquesta recomanació, es va demanar un pressupost per posar un nou parallamps. També s\'adjunta.\r\n\r\nAtesa els informes i el cost de la intervenció, sol·licitam:\r\n\r\n1. Que els tècnics de la conselleria valorin l\'adequació de la proposta de parallamp i la seva ubicació.\r\n\r\n2. I que, en el cas que sigui correcta, porti a terme aquesta actuació.\r\n\r\n\r\n\r\nQuedam a l\'espera de la seva resposta.', 805, 3, 1, '2025-07-24', '0000-00-00', NULL, 1, NULL, NULL, ''),
(306, '270-2025', '', 20, NULL, '', 0.00, 'N', 'Bon dia Helena,\r\n\r\nT\'envio la informació que ens demanes respecte a les obres de la cuina d\'Es Vinyet.\r\n\r\n1. Les obres de la nova cuina d\'Es Vinyet varen començar aquest passat 10 de juliol i la previsió segons contracte es de 4 mesos. Per tant, podeu comptar que la cuina estarà operativa a principis de novembre.\r\n\r\n2. A l\'inici del curs escolar es podrà oferir la modalitat de càtering. Tal i com es va comentar amb en Joan Payeras, es disposarà a l\'inici del curs d\'un espai amb la següent equipació per a que es pugui donar servei de càtering:\r\n- Carro calent\r\n- Equips frigorífics o carro fred\r\n- Congelador\r\n- Taules i estanteries\r\nAl no disposar de tren de rentat ja que es substitueix l\'actual, el càtering s\'haurà de preveure amb materials d\'un sol ús fins que el nou tren de rentat estigui operatiu.\r\n\r\n\r\nQualsevol dubte ho comentam.', 302, 1, 1, '2025-07-25', '0000-00-00', NULL, 1, NULL, NULL, ''),
(307, '271-2025', '', 224, NULL, 'Actuacions generals de manteniment al centre. Projecte reforma.', 0.00, 'N', 'Bon dia,  des del CEIP S\'ALGAR agraim tot l\'esforç que s\'està realitzant per reformar i millorar el nostre centre, però després de la visita de la tècnica i visualització del nou projecte de reforma del gimnàs, zona de menjador i quartos de bany, trobam que perdem espai de magatzem (No tenim altre espai) i el més important el quarto de bany exterior.\r\nAmb el nou projecte passam de tenir 2 banys  exteriors (un d\'ells inservible) i 1 bany interior a només un interior.\r\nVolem comunicar que el nostre centre necessita un bany exterior, ja que l\'escola és un espai obert al barri, a on es realitzen activitats fora de l\'horari lectiu,(escola de música, taekwondo, Espiral, curses del barri, centre d\'eleccions i altres activitats extraescolars ....) emprant aules exteriors i sense accès a l\'interior de l\'escola. A més és fonamental per l\'accessibilitat a l\'hora de l\'esplai dels infants del centre, per contribuir a crear un entorn més pràctic.\r\n\r\nDemanam que per favor es tengui en compte la nostra petició.\r\n\r\nSalutacions\r\n\r\nEQUIP DIRECTIU\r\nCEIP s\'Algar de s\'Arenal\r\nC/ Sant Bartomeu s/n\r\n07600 s\'Arenal de Llucmajor\r\nTel. primària: 971443309\r\nTel Infantil: 971441505', 399, 1, 1, '2025-07-29', '0000-00-00', NULL, 1, NULL, NULL, ''),
(308, '272-2025', '', 224, NULL, 'Reparacio del forjat de l\'edifici d\'educacio infantil.', 0.00, 'N', 'Bon dia,\r\nVolem informar que des del servei d\'infraestructures i Serveis Educatius, ens ha arribat en còpia el mail per sol.licitar la reparació pels petits desprendiments que hi ha hagut en el cantell de la coberta de l\'edifici d\'educació infantil o en el seu defecte una malla de protecció.\r\nper tant demanam que ens comuniqueu com teniu previs solventar aquesta deficiència.\r\nAgraesc  correu de confirmació que heu rebut el mail.\r\nSalutacions\r\n\r\n\r\nEQUIP DIRECTIU\r\nCEIP s\'Algar de s\'Arenal\r\nC/ Sant Bartomeu s/n\r\n07600 s\'Arenal de Llucmajor\r\nTel. primària: 971443309\r\nTel Infantil: 971441505', 399, 1, 1, '2025-07-29', '0000-00-00', NULL, 1, NULL, NULL, ''),
(309, '273-2025', '', 224, NULL, 'Reparacio de ratjoles en mal estat', 0.00, 'N', 'Bon dia, \r\nDia 21 de juliol vàrem enviar un mail  a brigada, sol.licitant la reparació de les rajoles d\'en terra d\'una de les aules de l\'escola (sala colindant menjador) ja que s\'han aixecat i no es pot trepijar ni accedir a l\'aula per perill. \r\nEns han contestat que la incidència està passada però no han vingut a arreglar-ho.\r\nAprofitam per recordar que al llarg del curs hem enviat successius mails per arreglar les rajoles dels banys del primer pis que varen caure i que són un perill de tall pels infants.\r\n\r\nAgraesc correu de confirmació que heu rebut el correu.\r\n\r\nSalutacions', 399, 1, 1, '2025-07-29', '0000-00-00', NULL, 1, NULL, NULL, ''),
(310, '274-2025', '', 53, NULL, 'Remodelacio de la façana del centre. Al mail comenten altre actuacions.', 0.00, 'N', 'Bon dia, envio aquest correu després de les conversacions mantingudes amb el sr. Marius Pons Barro.\r\nA l\'IES Josep Maria Quadrado esteim reorganitzant els espais i resulta que un laboratori de Biologia passarà a ser ocupada com a aula del cicle d\'FP Bàsica Manteniment d\'Habitatges.\r\nL\'esmentat cicle utilitza constantment un altre espai que és el Taller de Fusteria i necessita \"voltar\" bona part del centre per arribar-hi. Des de la seva aula de referència o bé la seva futura aula de referència (actual laboratori de Biologia) hi ha molta distància entre els dos espais.\r\nDes de l\'IES Josep Maria Quadrado sabem que la Conselleria ha de renovar tota la carpinteria metàl·lica de varies façanes del nostre edifici principal i on el laboratori de Biologia està inclòs.\r\nPer a una millor organització del centre creiem necessari transformar un finestral del laboratori de Biologia en portalada, ja que això faria possible una sortida directa al pati Sud just a la vora del Taller de Fusteria.\r\n\r\nEn resum, aprofitant la intervenció que s\'ha de fer al centre volem transformar una finestra en porta de sortida al pati Sud per a que l\'alumnat tengui una millor accessibilitat i evitar la \"volta\" que fa l\'alumnat d\'FP Bàsica amb les conseqüents molèsties que això origina a la resta de les sessions de classe.\r\nSi això no és possible per motius econòmics des del centre podem estudiar la possibilitat d\'assumir la diferència de cost de passar de finestra a porta i la part d\'obra que això implica.\r\n\r\nQuedam a la seva disposició per qualsevol dubte o aclariment.\r\n\r\nMoltes gràcies\r\n\r\n--\r\n_________________________________________________\r\n\r\nGabi Martínez Genestar \r\n\r\nCap d\'estudis d\'FP de l\'IES Josep Maria Quadrado', 796, 1, 1, '2025-07-30', '0000-00-00', NULL, 1, NULL, NULL, ''),
(311, '275-2025', '', 20, NULL, '', 0.00, 'N', 'Bon dia, \r\n\r\nsom n\'Albert Mayans, del CEIP Rosa dels Vents. \r\n\r\nDes de l\'AFA, que s\'encarrega de la gestió del menjador del centre, ens informen que el centre ha de disposar d\'una taula calenta per a aquest servei.\r\n\r\nFins ara, només ens han contestat dues empreses, de les quals us n\'adjuntam els pressupostos. \r\n\r\nEntenem que, en ser maquinària necessària, podeu fer-vos càrrec d\'aquesta despesa, és així? el nostre centre, ni l\'AFa, no disposam d\'aquests quantitats. Com hem de procedir?\r\n\r\nQuedam a l\'espera,\r\n\r\nGràcies', 397, 3, 1, '2025-08-04', '0000-00-00', 1, 1, NULL, NULL, ''),
(312, '276-2025', '', 6, NULL, 'Adaptació de les escales, possar arrambadors, per alumne amb mobilitat reduida.', 0.00, 'N', 'Bon dia, \r\nEl proper curs tendrem un alumne NEE, amb dificultats per pujar les escales(adjuntam imatges). Com honoodem fer per sol.licitar uns arrembadors ?\r\nLa primera escala té 12 escalons i la segona 8 escalons. Gràcies', 430, 11, 1, '2025-08-06', '0000-00-00', 1, 1, NULL, NULL, ''),
(313, '277-2025', '', 72, NULL, 'Consulta tècnica sobre la instal·lacio d\'una pergola a cost zero. Ve d\'una altre centre.', 0.00, 'N', 'A l\'atenció de:\r\n\r\nServei d\'Infraestructures Educatives - Secretaria Autonòmica de Desenvolupament Educatiu\r\n\r\n\r\nAmb còpia a:\r\n\r\nDirecció Territorial d\'Educació de Menorca\r\n\r\n\r\nAutorització A1/2025-2026. Pèrgola\r\n\r\nSol·licitam: Autorització per instal·lar pèrgola al centre\r\n\r\n\r\nExposició de motius\r\n\r\nAmb l’objectiu d’incrementar els espais d’ombra al nostre centre, s’ha constituït una comissió de treball amb la participació de l’AFA i del Consell Escolar. Fr fruit d’aquesta iniciativa, i gràcies a la col·laboració entre centres educatius, el CEIP de Ferreries i l’Ajuntament de Ferreries han posat a la nostra disposició una pèrgola que es retira d’aquest centre arran d’obres de millora i ampliació, les quals en fan innecessària la seva presència.\r\n\r\nAquesta pèrgola és de titularitat municipal, en el marc de les tasques de manteniment dels centres educatius a càrrec de l’Ajuntament, i es cedirà al nostre centre a cost zero. Les seves característiques tècniques són les següents: tamany 8 x 5 metres, columnes metàl·liques (ferro galvanitzat) i coberta de plaques d\'alumini.\r\n\r\nLa pèrgola es troba en bon estat i resta pendent determinar la seva ubicació exacta dins el recinte escolar. Segons l\'emplaçament definitiu, serà necessari dur a terme un tipus o un altre d’anclatge al terra.\r\n\r\nPer aquest motiu, sol·licitam a la Conselleria:\r\n\r\nque autoritzi la instal·lació de la pèrgola al nostre centre,\r\n\r\n\r\ni que ens indiqui si és necessari cap informe tècnic o cap altra gestió prèvia per poder dur a terme la instal·lació.\r\n\r\n\r\nS’adjunta imatge de la pèrgola en la seva ubicació original al CEIP de Ferreries.', 805, 1, 1, '2025-08-07', '0000-00-00', NULL, 1, NULL, NULL, '');
...
(863, 0, NULL, 'EI', '0700001', 'EI Son Serra de Marina', 'Son Serra', '07000', 'sta margalida', NULL, NULL, '971000000', '', 'sonserra@sonserra.es', NULL, NULL, NULL, 1, 52),
(864, 0, NULL, 'CEIP', '0700002', 'CEIP Felanitx', 'CEIP', '0700', 'Felanitx', NULL, NULL, '971111111', '', 'correofelanitx@felanitx.com', NULL, NULL, NULL, 1, 21);
...
CREATE TABLE `conveni` (
  ...
  `url_esborrany` varchar(1000) NOT NULL,
  `url_definitiu` varchar(1000) NOT NULL,
  `observacions` varchar(2000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `conveni` (`id`, `codi`, `descripcio`, `ajuntament_id`, `estat_conveni_id`, `data_signatura`, `data_inici`, `data_pagament`, `pressupost`, `url_esborrany`, `url_definitiu`, `observacions`) VALUES
(3, '2025-1', 'Conveni de prova e', 51, 1, '2025-04-16', '2025-04-03', '2025-04-16', 500.02, 'https://ibeducacio.sharepoint.com/sites/InfraestructuresEducatives/Documents%20compartits/Forms/AllItems.aspx?id=%2Fsites%2FInfraestructuresEducatives%2FDocuments%20compartits%2F2024%5FConvenisAjuntaments%2F2024%5FFelanitx%2FCONVENI%20FELANITX%2F20240916%5FDocumentaci%C3%B3%5FT%C3%A8cnica%2FCEIP%20REINA%20SOFIA%2F20241001%5F%40%5FE%5FAj%5FFelanitx%5FAct%5FCoberta%5FCEIP%5FReinaSofia%5FCEIP%5FJoanCapo%2Epdf&viewid=57087ec9%2Dd3e2%2D4a1c%2Da68b%2D13347f94cfc9&parent=%2Fsites%2FInfraestructuresEducatives%2FDocuments%20compartits%2F2024%5FConvenisAjuntaments%2F2024%5FFelanitx%2FCONVENI%20FELANITX%2F20240916%5FDocumentaci%C3%B3%5FT%C3%A8cnica%2FCEIP%20REINA%20SOFIA', 'https://ibeducacio.sharepoint.com/sites/InfraestructuresEducatives/Documents%20compartits/Forms/AllItems.aspx?id=%2Fsites%2FInfraestructuresEducatives%2FDocuments%20compartits%2F2024%5FConvenisAjuntaments%2F2024%5FFelanitx%2FCONVENI%20FELANITX%2F20240916%5FDocumentaci%C3%B3%5FT%C3%A8cnica%2FCEIP%20REINA%20SOFIA%2F20241001%5F%40%5FE%5FAj%5FFelanitx%5FAct%5FCoberta%5FCEIP%5FReinaSofia%5FCEIP%5FJoanCapo%2Epdf&viewid=57087ec9%2Dd3e2%2D4a1c%2Da68b%2D13347f94cfc9&parent=%2Fsites%2FInfraestructuresEducatives%2FDocuments%20compartits%2F2024%5FConvenisAjuntaments%2F2024%5FFelanitx%2FCONVENI%20FELANITX%2F20240916%5FDocumentaci%C3%B3%5FT%C3%A8cnica%2FCEIP%20REINA%20SOFIA', 'Primer conveni 4'),
(4, '2025-2', 'Conveni de col·laboració entre la Conselleria d’Educació i Universitats i l’Ajuntament de Felanitx', 21, 10, '2024-05-27', '2025-07-18', '2024-05-27', 225496.35, 'https://ibeducacio.sharepoint.com/sites/InfraestructuresEducatives/Documents%20compartits/Forms/AllItems.aspx?id=%2Fsites%2FInfraestructuresEducatives%2FDocuments%20compartits%2F2024%5FConvenisAjuntaments%2F2024%5FFelanitx%2FCONVENI%20FELANITX%2F20240319%5FConveni%2F20240319%5FEsborranys%2FConveni%20Felanitx%2019032024%281%29%2Epdf&viewid=57087ec9%2Dd3e2%2D4a1c%2Da68b%2D13347f94cfc9&parent=%2Fsites%2FInfraestructuresEducatives%2FDocuments%20compartits%2F2024%5FConvenisAjuntaments%2F2024%5FFelanitx%2FCONVENI%20FELANITX%2F20240319%5FConveni%2F20240319%5FEsborranys', 'https://ibeducacio.sharepoint.com/sites/InfraestructuresEducatives/Documents%20compartits/Forms/AllItems.aspx?id=%2Fsites%2FInfraestructuresEducatives%2FDocuments%20compartits%2F2024%5FConvenisAjuntaments%2F2024%5FFelanitx%2FCONVENI%20FELANITX%2F20240319%5FConveni%2F20240426%5FConveniFelanitxDefinitiu%2FConveni%20Ajuntament%20de%20Felanitx%20signat%2Epdf&viewid=57087ec9%2Dd3e2%2D4a1c%2Da68b%2D13347f94cfc9&parent=%2Fsites%2FInfraestructuresEducatives%2FDocuments%20compartits%2F2024%5FConvenisAjuntaments%2F2024%5FFelanitx%2FCONVENI%20FELANITX%2F20240319%5FConveni%2F20240426%5FConveniFelanitxDefinitiu', 'Conveni de col·laboració entre la Conselleria d’Educació i Universitats i l’Ajuntament de Felanitx per al finançament i l’execució de les obres de millora de les infraestructures educatives del terme municipal de Felanitx');
...
(83, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EuWxC7tWKLJIuKm7FO8evAAB0CXHyPmNZm51Vc390i0dUQ?e=pEzU9f', '2025-05-23', 101),
...
(100, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EfX6RYFqLxhCgYDAT2f4gxYBFfltDTxI9faVIavwDU1VTQ?e=bHDDBr', '2025-05-07', 115),
...
(330, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/ElTS5AKkJ6RCl4cb3fM6oeMBLkLjci87IGiTESacH-lcEA?e=Ee2Imb', '2025-07-16', 268),
(332, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Ej_vMMT9zzNEn9qT51NsmdUBlc98Ek9ZAptR6p2hPRrqyQ?e=22yUQx', '2025-07-14', 267),
(333, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Es3LxlNyF61NrXOyBrF6M9UB0H-1Mx5o8_VVy3t2We4G2Q?e=hMHlf4', '2025-07-08', 266),
(334, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EsYFcJ03d71DmoGbmT9nFFoB_RdaiU4SDr-0pzOn-zAGrg?e=vusPRE', '2025-07-16', 269),
(335, 'Carpeta dels documents del centre', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EtRsjrpyHfxMg9-8--4n6RkBSwjciR92yqF-Rl_TjCFI7A?e=5AEM5D', '2025-07-16', 270),
(336, 'Carpeta dels documents a l\'IBISEC', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EmTank_2X4xNhNJG39BuoIoBct328X6Z--r81tfryMc7_w?e=nnoebl', '2025-07-16', 270),
(337, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EsQPBI6fQyROqE9soYCy4uUBLurmkAC9D9V-V2fMEYnTNQ?e=wkiapf', '2025-07-16', 271),
(338, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/ErsqR-vua2FIs8tcIgnDATgBiPE_LNZvYIoyj3RKyCsC0w?e=y7E7Kk', '2025-07-04', 272),
(339, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Et17Sz163G9Eoier5SEbEBcBB-TxSk-HbuSitiVyRovm5Q?e=C7lZs9', '2025-07-08', 273),
(341, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EgQik_CWFNZLkhDlO9KqYTIBvd2y7gGLATVl22rXxMNsrA?e=3dGY1n', '2025-07-17', 274),
(342, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Et4X_5Dcj8tJsnJU0glF56QBCqNUAz3pLqsUdus9g6IisA?e=t1qTNL', '2025-07-09', 275),
(343, 'Fotos', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EtvkLIrjFl5KvUVuE3qsIYYBjdEOvODMDEmwUEpijTvQVw?e=WTD117', '2025-07-17', 274),
(344, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EpT7Y6BZGzxCkaXCth74JfABhhyzOloqaErcFh47JnU0zg?e=pX0v6x', '2025-07-11', 276),
(345, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Ei2ufwm6HRFPprTEF-Y98z0B5K2b5b20OAScibdXVYolVg?e=AwfyFb', '2025-07-18', 277),
(346, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EYbFjGxA_uRGnoTWkdxxZXsBTXZA1c5N2x0ksRm1fIAQPw?e=fg6ygj', '2025-07-15', 278),
(347, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Ek_fsIcEz6NCvfe6Ib5WaJ0BqktkvlrZyFa5vtG5OXizfQ?e=gBIwFI', '2025-07-18', 279),
(348, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Egn31BLPZZNBs-J0vRqvEqUB2gnkS2KnH5HvLsbtFXZOhg?e=xCqsmI', '0000-00-00', 280),
(349, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Es0V0QmTjRFJly0semKwb9IBc-TXXyZ9AH3d3HPJVhRLPQ?e=QHmgtt', '2025-07-10', 281),
(350, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/Ec_eL9Y2zcZBjbXoBXIcUbYBaZNDV2BIGcrk4syN_5HEzg?e=YhJgds', '2025-07-10', 282),
(351, 'Fotos', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EowqgtQhnhFPvpwt8kxBEeYBi2QSv3pR6-Yl66TqhTzPeg?e=NVF8v9', '2025-07-10', 282),
(352, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Eg2EWGkOxo9OjnXa3F9fN_IBghWsh1VW1UxUVc6zht-aGQ?e=WGfqR3', '2025-07-18', 283),
(353, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EbWwM_LvPZJKjKcAj3wM1LEBfZSRbBY1B0atB73LuhHM6g?e=SiRZ9o', '2025-07-18', 285),
(354, 'Pressupost', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EbWwM_LvPZJKjKcAj3wM1LEBfZSRbBY1B0atB73LuhHM6g?e=1qSqEs', '2025-07-18', 285),
(355, 'Fotos', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EhyYapZjfwBKhmgs-KKRExcBa1RMHpMgKFcc32O4t3YYVQ?e=iXZq0u', '2025-07-14', 286),
(356, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EZumMQFSV0NGvPx-jFmGvP8BxyuGCH_klDCQaOphttJNNA?e=t7om5U', '2025-07-14', 286),
(357, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EdZqPZwp7axMrEh5f6nAdQgBlFfKiSmDVL8dSLab93YKcQ?e=ixprVr', '2025-07-14', 287),
(358, 'Fotos', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EgRqct0uSLhJlchpHhsF7XkBxDO8vsm6tDe7624Dvu_X9g?e=XMYH0k', '2025-07-14', 287),
(359, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EkqSJRSjfV1Choye8pCGF6cBoHmBWzHl4gmB97Tmh9QlOA?e=22PGcG', '2025-07-14', 288),
(362, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EiHFScWrQB1CmkRV_kmimbcB4NPOUWW0LPaA1p73ZGPEdQ?e=dffOHr', '2025-07-15', 290),
(363, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/Ef9CxPo4ZEJLkh3VSqmYSPAB2XMrAC1vQHfuz0PcMWYa4A?e=950xqr', '2025-07-21', 291),
(364, 'Sol·licitud', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/Ef9CxPo4ZEJLkh3VSqmYSPAB2XMrAC1vQHfuz0PcMWYa4A?e=kNbC8H', '2025-07-21', 291),
(365, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EpfZWPW2S-tGpr44mTgOd80BIETLdLNUhsw2N99YFPzR8A?e=a533Dv', '2025-07-22', 292),
(366, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EpSCjAmAM5NFnT0iAgcqLDoBmkrshkEUQjAZk6ARSM5E4A?e=kN6F0i', '2025-07-22', 293),
(367, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/ETampZiN3-ZHsjY_hUlWiaYBjY_v0HnrCgLpYjJk9gsXbQ?e=nQgNoy', '2025-07-22', 294),
(368, 'Fotos', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Es4sHr7FBuRPoccU7w4bIP4B95sjocAb-GdbNWZN_mXvLg?e=UBdqKE', '2025-07-22', 294),
(371, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EuzHrY7v3MdDvP9khwlvPNkBsNJX9BvLzv7wcMaFZXGzdg?e=h8tevA', '2025-07-22', 295),
(372, 'Plànol', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/ERRN3tEjzgRJuwDiAGx_XNABn7HDWsncquVyN2JW5FGIBw?e=BYoFJV', '2025-07-22', 295),
(373, 'Fotos', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EtpAtiwf_k5Ooz0Hu0SZ1GIBlbZ6vYYYErcJQay8NaLibQ?e=bWNjTq', '2025-07-22', 295),
(374, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Em-T117hl91AqeJLIc5B4g0BhtOoYRRMO6oL7Pw9nqxUgQ?e=eUr4T1', '2025-07-22', 296),
(375, 'Pressupots', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EkImRTBCNwhDhuNhlDEQszwBKXJqARburKNbzJjeNeVsHQ?e=IFemBg', '2025-07-22', 296),
(376, 'Projecte', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Etw1ObYje4hMq-53dk7iwcsB0UFddPIMkFwt06_uvpLb8w?e=sCOFgj', '2025-07-22', 296),
(377, 'Ripea', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EvkcRkWP1StKh952Pj6hu6QBawPY_G5vGYG6dz-LudJCQQ?e=YwqvEw', '2025-07-22', 296),
(378, 'Propostes tècniques', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EkcZWP5ZPUxOq0P04C4zYhYBwucsMTxClp5RL8hIUUO01A?e=vfZXe1', '2025-07-18', 115),
(379, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EmiI3sRAUcVHmqN2NcBCfqcBLoBANe7W-QmOvgBSJqoO2Q?e=S5tBvv', '2025-07-22', 297),
(382, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EUZuIde_scROgA72QMTiKw4B6hF64lNC6F-1cSaLg-OS7Q?e=GlBa3h', '2025-07-23', 300),
(383, 'Foptos', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EjhO1BEnZYtEorcedH_fdy0Bbu7ZYo-fPQI0xffFif-LGA?e=SwQNMa', '2025-07-23', 300),
(385, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/ERxP6QwtuK5Jq0Juvs7G49sBFIxsU-ZbZwXhcuCU6KpMRQ?e=3ynN0y', '2025-07-22', 302),
(386, 'Carpeta dels pressupots', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Eryc2ZMD5fBOvOq4XWedVXQBsXZV-p-UttGpNpJ9A9X90A?e=yDM9gZ', '2025-07-22', 302),
(389, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Etlp3J14lvFPvPnnH9CAd2QB7YunSgxr_vtbZA4f4TOuAA?e=ABcSWU', '2025-07-23', 305),
(390, 'Pressuposts', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Ep5slw9AZytNiltRzoo8kUYBd4fikljCdYJ0wEsI2aF_sQ?e=eAC9Wy', '2025-07-23', 305),
(391, 'Sistema de verificacio', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/ErZZ7dHAo3hNq9AFaJ7PRMcBKBncRcG2csBjG_In5Kw18g?e=RDTKa6', '2025-07-23', 305),
(392, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Ek-AHnv6L99AqHkqSbl1qtMBc9j6VG2dTbRZPPonS-AQ8w?e=55WxgD', '2025-07-23', 306),
(393, 'Pressuposts', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EtDvIQL_YCtEm7k23wJHRz8BpyCwGhPQZqfsayZ2FGwtFQ?e=cNEGhE', '2025-07-25', 268),
(394, 'Plànols Llanterneria', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EkSOutiF5lxOkVlnqhIYQG4B56HQq0kE0oxspCglFYgzFQ?e=EeEzsY', '2025-07-25', 268),
(395, 'Ofici resposta a l\'Ajuntament', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EtuFmQNKuaRIlTGlI9pVYOYBjuelP_ghDQESe61jrG-74w?e=dI9hMd', '2025-07-25', 267),
(396, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EVsGxrPizi9CrUaQOuhbNn8BLbq6Q3rPnS_wQEkxYXKlBA?e=Nf2hTr', '2025-07-25', 203),
(397, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EtaLE3wkRplClaG6TYbyOkYBDW2PPY_nK_IESftIJWBjFQ?e=VihrGJ', '2025-07-29', 307),
(398, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EehFKjNglZ1GqQQNLZ_P88UBlFXzkL4svYWY2LJqgEEBvg?e=a764nj', '2025-07-29', 308),
(399, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EZpV7wm_uWlLtd3Buxz5KEkBm2Zke7I3qDBGbGWNiaKfiA?e=fEziAk', '2025-07-29', 309),
(400, 'Fotos', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EkJoxcAt1IFKsvPIydp9FEIBMGgCt7lpaduV1aORlGbF6A?e=GcBbgb', '2025-07-29', 309),
(401, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/ElBWx5qxVRJDumxVVJ6Wy6kBpnSz9Np2vNIEpJ7YQi4v4w?e=I30p2G', '2025-07-30', 310),
(402, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EfUeEiI9PdZOuSFPgVb-BQwB1J6K9skNtw8OhwLdszMggw?e=8z2Fkd', '2025-07-31', 311),
(403, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Em_qc93krHlJq1BiA4LSlvUBFDsaEM1Z4Vabu2MmTS7H-g?e=muoQ4l', '2025-07-31', 311),
(404, 'Pressupost', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Etc9hqIIwd1HrQXtkill8PIB1Gg8u2pO6SDLBMaYDOJFDQ?e=i66rRu', '2025-08-05', 56),
(405, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EdSnTejnAvRJqfuI10QoShEBMtuAvX0hKGMLHm2AtUO1CQ?e=7BInXm', '2025-08-05', 312),
(406, 'Carpeta de fotos', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EmUl-fy7kllCseyUYKdUXvsBXN06BYaUE0MKL7TDeWyghw?e=g8za3j', '2025-08-05', 312),
(407, 'Carpeta dels documents', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EWauWxPVOW9Hv2i57KXSS90BSEn9l1_lJDebuAvLEO__6w?e=OYJkhI', '2025-08-07', 313),
(408, 'Foto', 'https://ibeducacio.sharepoint.com/:i:/s/InfraestructuresEducatives/EYBSdWnkphJIgilKp-2ckAoBOD-Gx5j61YJx5nl0KlVOZw?e=7IRd6V', '2025-08-07', 313);
...
--
-- Bolcament de dades per a la taula `pagament_conveni`
--

INSERT INTO `pagament_conveni` (`id`, `id_actuacio`, `data`, `import`, `concepte`) VALUES
(4, 1, '2025-07-17', 50.01, 'proveta 2');
...
(98, '2025-07-16', 'Reiteració de la creació d\'aula nova', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/Efu0SorZrdVBlQ6SxV1M0zkB_5x4h9dXEVCSolmYmd4V8A?e=2FClI0', 240),
(99, '2025-07-17', 'Autorització', '', 207),
(100, '2025-07-02', 'OFICI. Comunicació de les obres previstes al CEIP Sa Marina i al CEIP Badies de Llucmajor que han enviat des del gabinet del conseller.', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EU6Ynsb36ZBMlBgJL2RzCvIBaOwO9oY76fF4RvsI8HHrEA?e=S8y9C6', 91),
(101, '2025-07-17', 'Tala Pins', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/ErCNxwkSQA5PtwitDz6_SGMB92c899t0S22aJM55etP1WA?e=YJM43h', 121),
(102, '0000-00-00', 'OFICI. Comunicació compromis obres previstes.', '', 256),
(103, '2025-07-18', 'Reiteració del centre', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EZwyAKlyxaBBn3mJr2OHDfkBcDflYJSid12DsKNmuZlmGA?e=zZS5qA', 174),
(104, '2025-07-18', 'Pressuposts', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Eis_w4Sovu9GqjqfrrJyVtkBu6wKDvcLzgKYsUUGuoUBGg?e=AguKDa', 122),
(105, '2025-07-17', 'Reiteracio de les accions. Biblitoteca i ascensor', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/Erj9mJhwc4RLvo9VHb7LcOIBmWHBeRwwoUzF0l0kH-N0FQ?e=xleqHE', 137),
(106, '2025-07-17', 'Reiteracio de les accions. Biblitoteca i ascensor', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EndcMyqfOQ9Bn-Ok7sAuDV0BXLd7fjAKUof0o-_I-irdMA?e=y92BrT', 137),
(107, '2025-07-15', 'Pressupots', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EqvF5OH2xnlEkE4LXepcEc0B9ueqxnsjQ-0vJ928_ypLvg?e=GT5r2H', 111),
(108, '2025-07-15', 'Reiteracio de la sol·licitud per a l\'instal·lacio d\'un pergola', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EvJkqgEMFEdCiMzh4LbWDBwBRRncgfvnh49mA6obTMbJPA?e=YmICAm', 164),
(109, '2025-07-22', 'L\'empresa instal.ladora demana al centre confimrar l\'estat de la coberta després de l\'impermeabilització.', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EQIZif7I81hGk8tATXbwkpEBa7rNchfzVoa4eo1r7YCkaw?e=NlIaHC', 152),
(110, '2025-07-22', 'Comunicació de la tècnica de l\'ajuntament i fil dels missatges', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EXCVxQw2mE1Ms4q4sUWKdosBmQOczjJ7oWmSsl3tK5FLdQ?e=R0Jigx', 292),
(111, '2025-07-22', 'Sol·licitud Ibisec. Autorització del projecte', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/ETPkVzJ0CbNDkl3yrIJ8mr0BkOJmKTPLUZwtHCnLLlBIkw?e=SK6dNp', 293),
(112, '2025-07-22', 'Tramessa a sol·licitud Toni Morro', 'https://ibeducacio.sharepoint.com/:f:/s/InfraestructuresEducatives/EvkcRkWP1StKh952Pj6hu6QBawPY_G5vGYG6dz-LudJCQQ?e=YwqvEw', 296),
(113, '2025-05-07', 'Sol·licitud d’instal·lació d’estructura de joc per al pati d’educació infantil', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/ESw2OuSWGl5BiXNSvnjmKIwBwmfmS_uAV2E5ksrQ1zQ8UA?e=erp6qq', 115),
(114, '2025-07-08', 'Resposta. Es sol·liciten tres presuposts i fotografies de l\'espai on volen instal·lar les estructures de joc, a més d\'una imatge aèria de google remarcant la zona.', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/ESw2OuSWGl5BiXNSvnjmKIwBwmfmS_uAV2E5ksrQ1zQ8UA?e=jybKOJ', 115),
(115, '2025-07-25', 'Actuacio tancada per ordre de l\'IBISEC i el departament d\'infracestructures educatives', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/ERabThA3upJMl1-GYYdjIzABkHIPhac3WLJHlpRYZC5sUg?e=Bl1xBJ', 254),
(116, '2025-07-25', 'Reiteració', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EVsGxrPizi9CrUaQOuhbNn8BLbq6Q3rPnS_wQEkxYXKlBA?e=jac2qi', 203),
(117, '2025-07-29', 'Aceptacio del pressupost. Aceptacio expendient de despessa.', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/ESVK5B49tRZNhNvdUclhAxMB9YOQvyYpl9TnFf1J6RZhOA?e=AQCvGS', 257),
(118, '2025-07-30', 'Pagament renovació equips anti incendis', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EZMSGiLHvkRBq2ljo8VIQxwB1VO0u2uOx0rf_5P6SD8UYw?e=6bVCdy', 239),
(119, '2025-08-01', 'Reiterat la petició a IBISEC. Informat al centre.', '', 278),
(120, '2025-07-18', 'Sol·licitat @ informe a l\'IBISEC.', '', 278),
(121, '2025-08-01', 'Resposta del tecnic al centre sobre la zona d\'ombres', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EVrirtGgnktMnT3T7EwLir0BAv6bPYQd-ADYgd4iJJAYkQ?e=zkzW7b', 278),
(122, '2025-08-01', 'No s\'especifica per quin motiu és necessari que sigui porta d\'emergència. Es sol·licita @ informació addicional.', '', 232),
(123, '2025-08-01', 'Mail entre Servei i IBISEC sobre la peticio d\'informes', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/ES49mTfgcFNHlWENmgmUkVgB7Ol7OeT7SkWlSCPrGr4d0w?e=sWTofZ', 278),
(124, '2025-08-06', 'Es sol·licita el pressupost per tal de poder donar el vistiplau a l\'actuació.', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EQxCw8-NAnNOrkzG2EmoRpQB8-hhFaYcUkI8M8ikZMBurA?e=kVaZPl', 238),
(129, '2025-08-06', 'Arrambardors Escales', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EckPidT2kZ9OmtwbzdtIMRcBKEi9CWheZXm4EvvUFy-otg?e=PePKdt', 312),
(130, '2025-08-06', 'arreglar deficiencies OCA', 'https://ibeducacio.sharepoint.com/:b:/s/InfraestructuresEducatives/EdYLH70-iF9NpACEIOwOWOQB4MNjKfvPdoIFusx0laK-Gw?e=RgLqtZ', 302);
