// $Id: dhtmlgoodies_calendar.js,v 1.6 2007/04/26 07:31:05 fros Exp $
/*
...
*/
var languageCode = 'ca';	// Possible values: 	ca,en,ge,no,nl,es,pt-br,fr	
...
var pathToImages = 'imagenes/calendario/';	// Relative to your HTML file
...
switch(languageCode){
	...
	case "es": /* Spanish */
		...
		break;
	case "ca": /* Català */
		var monthArray = ['Gener','Febrer','Març','Abril','Maig','Juny','Juliol','Agost','Septembre','Octubre','Novembre','Decembre'];
		var monthArrayShort =['Gen','Feb','Mar','Abr','Ma','Jun','Jul','Ago','Sep','Oct','Nov','Dec'];
		var dayArray = ['DL','DT','DC','DJ','DV','DS','DG'];
		var weekString = 'Setmana';
		var todayString = 'Avui és';
		break;  	
...
var selectBoxRolloverBgColor = '#d9cbbc'; // Background color on drop down lists(rollover)
var colorTituloDia = '#C2AD96'; //color de la cabecera de cada semana (nombre de los días), añadido por MHU
...
function selectMonth()
{
	...
	document.getElementById('monthDropDown').style.display='none';
	//// fix for EI frame problem on time dropdowns 09/30/2006
        // MHU.añadida condicion para que la función EIS_Hide_Frame solamante se ejecute en IE
				if(MSIE)
                                {EIS_Hide_Frame();}
...
function writeCalendarContent()
{
	...
	for(var no=0;no<dayArray.length;no++){
		...
		//insertado por mhu para cambiar el color de la cabecera de los dias de la semana
		cell.style.color = colorTituloDia;
	}
