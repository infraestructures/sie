...
if ($return_qs === '' && isset($_POST['cadastre_us_principal_filtro'])) {
    $return_qs = 'cadastre_us_principal_filtro=' . urlencode($_POST['cadastre_us_principal_filtro']);
}
$codi = $_POST['codi'];
$sigla = $_POST['sigla'];
$centre = $_POST['centre'];
...
if ($stmt->execute()) {
    $redirectUrl = "centreListFiltro.php" . ($return_qs !== "" ? ("?" . $return_qs) : "");
